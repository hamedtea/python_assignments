...
class Character:
    ...
    def printout(self):
        ...
        print(f"Hitpoints: {self.get_hitpoints()}")
    ...
    def attack(self, target, weapon):
        ...
        if   self.__str__ == target.__str__ and weapon in WEAPONS:
        ...
        elif weapon not in self.__item_list:
            print(f"Attack fails: {self.get_name()} doesn't", f'have "{weapon}".')
        else:
